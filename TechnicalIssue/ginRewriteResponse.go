 ...
 * Gin server receives requests and acts as a reverse proxy for the requested url.
 * Proxy entrypoint is a json mock server http://dummyjson.com.
 *
...
func signature() gin.HandlerFunc {
	return func(c *gin.Context) {
		// TODO : Add the signature uuid in the response output payload
	}
}
